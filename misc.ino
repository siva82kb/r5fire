/*
 * This file contains functions for carrying out the following
 * operations.
 * 1. Reading and converting all sensor data.
...
void readAllSensorData() {
    // Read encoders
    angleLeft.add(encLeft.read() * ENCONVFACTOR);
    angleRight.add(encRight.read() * ENCONVFACTOR);
}
